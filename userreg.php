...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        $check_query = "SELECT * FROM applicant WHERE national_id = '$national_id'";
        ...
        $stmt = $conn->prepare("INSERT INTO applicant ( full_name, national_id,password, phone_number, email) VALUES ( ?, ?, ?, ?, ?)");
